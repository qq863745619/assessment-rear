package com.nju.software.assessment.config;
...
@EnableJpaRepositories(basePackages = "com.nju.software.assessment.dao2",
...
public class JpaConfigTwo {
    ...
    LocalContainerEntityManagerFactoryBean entityManagerFactoryBeanTwo(
        ...
        return builder.dataSource(dsTwo)
                ...
                .packages("com.nju.software.assessment.bean2")
                .persistenceUnit("pu2")
                .build();
    }
